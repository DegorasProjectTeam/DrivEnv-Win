# =====================================================================
#  DEGORAS overlay port: mongo-cxx-driver (static build)
# =====================================================================
...
# Force 'INLINE_VAR' to real 'inline'
string(APPEND VCPKG_CXX_FLAGS " -DINLINE_VAR=inline")
set(VCPKG_C_FLAGS   "${VCPKG_C_FLAGS} -DINLINE_VAR=inline")
set(VCPKG_CXX_FLAGS "${VCPKG_CXX_FLAGS} -DINLINE_VAR=inline")
